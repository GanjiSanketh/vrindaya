...
/**
 * Browse-grid categories (Shop By Category section).
 * These are the tile categories shown on the home page grid —
 * different from the navbar filter categories in ProductService.
 */
