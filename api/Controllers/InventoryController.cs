...
/// <summary>
/// Product Lifecycle stage transitions — admin-only, narrow partial writes
/// against the products collection ProductController already owns.
/// Composes ILifecycleService directly rather than going through
/// IProductService, mirroring how IProductStorageService is already called
/// directly by ProductController for the same "doesn't need the full
/// product-editorial path" reason.
/// </summary>
[ApiController]
[ApiVersion("1.0")]
...
public class InventoryController : ControllerBase
{
    ...
    public InventoryController(ILifecycleService lifecycleService)
    {
